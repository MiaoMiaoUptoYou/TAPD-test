...
class TestTest4():
    ...
    def test_test4(self):
        ...
        time.sleep(3)
        #删除
        self.driver.find_element(By.CSS_SELECTOR, ".el-form > .el-form-item:nth-child(1) .el-input__inner").click()
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-form > .el-form-item:nth-child(1) .el-input__inner").send_keys(
            "2018")
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").click()
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").send_keys("a")
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-button--primary > .el-icon-search").click()
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-table__row .el-checkbox__inner").click()
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-button--danger").click()
        time.sleep(3)
        element = self.driver.find_element(By.CSS_SELECTOR, ".el-button--danger")
        time.sleep(3)
        ...
        actions.move_to_element(element).perform()
        time.sleep(3)
        self.driver.find_element(By.CSS_SELECTOR, ".el-button--small:nth-child(2) > span").click()
        time.sleep(3)
        element = self.driver.find_element(By.CSS_SELECTOR, ".el-button--small:nth-child(2)")
        time.sleep(3)
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
        time.sleep(3)
